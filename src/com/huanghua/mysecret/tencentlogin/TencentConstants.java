package com.huanghua.mysecret.tencentlogin;

public class TencentConstants {
    public static final String TAG = "tencent_login";
    public static final String USER_NAME_HEAD = "tencent_login_";
    public static String APP_ID = "1102011854";
